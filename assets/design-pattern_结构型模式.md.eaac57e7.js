import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.b96c6c14.js";const h=JSON.parse('{"title":"结构型模式","description":"","frontmatter":{},"headers":[],"relativePath":"design-pattern/结构型模式.md","filePath":"design-pattern/结构型模式.md","lastUpdated":1698927986000}'),l={name:"design-pattern/结构型模式.md"},o=p(`<h1 id="结构型模式" tabindex="-1">结构型模式 <a class="header-anchor" href="#结构型模式" aria-label="Permalink to &quot;结构型模式&quot;">​</a></h1><h2 id="adapter-适配器" tabindex="-1">Adapter(适配器) <a class="header-anchor" href="#adapter-适配器" aria-label="Permalink to &quot;Adapter(适配器)&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">意图</p><p>将一个类的接口转换为用户希望的另外一个接口。</p></div><p>常用场景：封装有缺陷的接口设计、统一多个类的接口设计、兼容老版本接口、适配不同格式的数据等。</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 目标接口</span></span>
